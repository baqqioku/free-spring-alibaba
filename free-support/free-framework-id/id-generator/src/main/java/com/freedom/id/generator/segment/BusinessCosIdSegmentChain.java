...
public class BusinessCosIdSegmentChain extends LinkedList<BusinessCosIdSegmentChain.BusinessCosIdGenerator> {
    ...
    void setLastNext(BusinessCosIdGenerator newBusinessCosIdGenerator) {
        putSegmentChainTime = LocalDateTime.now();
        availableCount.addAndGet(newBusinessCosIdGenerator.getEndId() - newBusinessCosIdGenerator.startId);
        offer(newBusinessCosIdGenerator);
